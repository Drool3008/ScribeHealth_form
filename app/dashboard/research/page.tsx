  ...
  return (
    <div className="flex flex-1 flex-col py-4 md:gap-4 md:py-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 lg:px-6 mt-4">
        <Card className="border shadow-none hover:bg-muted/5 transition-all duration-300">
          <CardHeader className="pb-2">
            <div className="flex justify-between items-center">
              ...
              <Link href="/dashboard/research/rq1" className="text-xs text-primary hover:underline">Details</Link>
            </div>
        ...
        <Card className="border shadow-none hover:bg-muted/5 transition-all duration-300">
          <CardHeader className="pb-2">
            <div className="flex justify-between items-center">
              ...
              <Link href="/dashboard/research/rq2" className="text-xs text-primary hover:underline">Details</Link>
            </div>
        ...
        <Card className="border shadow-none hover:bg-muted/5 transition-all duration-300">
          <CardHeader className="pb-2">
            <div className="flex justify-between items-center">
              ...
              <Link href="/dashboard/research/rq3" className="text-xs text-primary hover:underline">Details</Link>
            </div>
        ...
        <Card className="border shadow-none hover:bg-muted/5 transition-all duration-300">
          <CardHeader className="pb-2">
            <div className="flex justify-between items-center">
              ...
              <Link href="/dashboard/research/rq4" className="text-xs text-primary hover:underline">Details</Link>
            </div>
